...
public class leevtest {
    ...
    public void testEquals() throws ParseException {
        ...
        leev l = new leev(32,"maternity","pains","approved",d,d1,2,2,"notfeelingwell",d2);
        leev l1 = new leev(32,"maternity","pains","approved",d,d1,2,2,"notfeelingwell",d2);
        leev l2 = new leev(31,"sick","fever","approved",d3,d,1,2,"fever",d4);
        assertEquals(l, l1);
   ...
   */
      ...
      public final void testapproveDeny(@Mocked final leevDAO dao) throws ParseException {
        ...
        String str1 = leev.approveDeny(31,50975, "APPROVE");
        assertEquals(str1, "Invalid LeaveId");
        String str2 = leev.approveDeny(32,50996, "APPROVE");
        assertEquals(str2, "Leave Approved Successfully");
        String str3 = leev.approveDeny(33,50960, "APPROVE");
        assertEquals(str3, "You are not authorised to access this employee.");
        String str4 = leev.approveDeny(31,50959, "DENY");
        assertEquals(str4, "Leave Rejected");
        String str5 = leev.approveDeny(32,50975, "DENY");
        assertEquals(str5, "Leave Rejected");
        String str6 = leev.approveDeny(33,50996, "APPROVE");
        assertEquals(str6, "Leave Approved Successfully");
        String str7 = leev.approveDeny(31,50959, "APPROVE");
